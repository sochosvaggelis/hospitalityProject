...
const sections = {
    el: [
        ...
        ['2. Περιγραφή Υπηρεσίας', 'Το SeaSide Jobs είναι πλατφόρμα που συνδέει επαγγελματίες φιλοξενίας με επιχειρήσεις στα ελληνικά νησιά. Δεν είμαστε εργοδότης και δεν εγγυόμαστε την πρόσληψη ή την ποιότητα των αγγελιών.'],
    ...
    en: [
        ...
        ['2. Service Description', 'SeaSide Jobs is a platform connecting hospitality professionals with businesses on the Greek islands. We are not an employer and do not guarantee hiring or the quality of job listings.'],
